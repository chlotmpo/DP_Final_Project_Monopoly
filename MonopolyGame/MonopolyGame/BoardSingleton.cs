...
namespace MonopolyGame
{
    public sealed class BoardSingleton
    {
        ...
        {    
            ...
            boardGame[1] = new Property("Vine Street", 60, 4,"Brown", 2, 1);
            ...
            boardGame[9] = new Property("Whitechapel Road", 120, 10, "Light Blue", 3, 9);
            boardGame[10] = new Jail(10);
            boardGame[11] = new Property("The Angel, Islington", 140, 12, "Purple", 3, 11);
            ...
            boardGame[19] = new Property("Old Kent Road", 200, 18, "Orange", 3, 19);
            boardGame[20] = new Special("Free Parking", 20, false, false, true);
            boardGame[21] = new Property("Whitehall", 220, 20, "Red", 3, 21);
            ...
            boardGame[29] = new Property("Regent Street", 280, 28, "Yellow", 3, 29);
            boardGame[30] = new Special("Go to Jail!", 30, false, true, false);
            boardGame[31] = new Property("Euston Road", 300, 30, "Green", 3, 31);
            ...
            boardGame[39] = new Property("Mayfair", 400, 38,"Dark Blue", 2, 39);
